...
namespace System.Security.Cryptography
{
   ...
   */
    ...
    public class ScryptEncoder
    {
        ...
        private static readonly RandomNumberGenerator DefaultSaltGenerator = RandomNumberGenerator.Create();
        ...
        public ScryptEncoder()
            : this(DefaultIterationCount, DefaultBlockSize, DefaultThreadCount, DefaultSaltGenerator)
        {
        }
        ...
        public ScryptEncoder(int iterationCount, int blockSize, int threadCount)
            : this(iterationCount, blockSize, threadCount, DefaultSaltGenerator)
        {
        }
        ...
        public bool Compare(string password, string hashedPassword)
        {
            ...
            ExtractHeader(hashedPassword, out var version, out var iterationCount, out var blockSize, out var threadCount, out var saltBytes);
